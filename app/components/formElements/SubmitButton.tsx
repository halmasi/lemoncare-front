...
export default function SubmitButton({
  ...
  return link ? (
    <Link
      className={`flex px-6 py-2 text-lg font-semibold rounded-lg border text-foreground bg-gray-50 hover:text-background/80 hover:bg-accent-green/80 transition-colors ease-in-out drop-shadow-md
